...
class MineField{
	...
	/*fasjdfoasidjfiaj
	faosidjfoasidjfoisdj	
	aoisdjfoaisjdfiasdjfa
	asoidjfoaisjdf
	foijwiejowi
	woiefoaidjsfiasjd
	fijoaisdjfoiajsdf
	...
	*/
	...
	//Increases count, splitted from the constructor.
	private void findChar(int row, int col, int count){
	...
	//Checks if the input from user is legal and within the ranges of the game.
